...
const EditProduct = () => {
    ...
    <div className="container">
      {editedProduct && (
        <div className="detail-details">
          ...
          <h1 style={{fontFamily:"'Domine', serif" , color:"#4f3267" , marginLeft:"20px"}}>Edit Product</h1>
          </div>
          <div className="detail-info">
            <div className="row">
              <div className="col" style={{fontFamily:"'Mulish', sans-serif", fontSize:"18px"}}>
                <label><b>Category:</b></label>
                <span>{editedProduct.category}</span>
              </div>
            </div>
            <div className="row">
              <div className="col" style={{fontFamily:"'Mulish', sans-serif", fontSize:"18px", marginTop:"20px"}}>
            ...
            <div className="row">
              <div className="col-md-3">
                <label style={{fontFamily:"'Mulish', sans-serif", fontSize:"18px", marginTop:"100px"}}><b>Select Sizes:</b></label>
                <select
                  multiple
                  name="size"
              ...
              <div className="col-md-3">
                <label style={{fontFamily:"'Mulish', sans-serif", fontSize:"18px", marginTop:"100px"}}><b>Gold Type:</b></label>
                <select
                  name="goldType"
              ...
              <div className="col-md-3">
                <label style={{fontFamily:"'Mulish', sans-serif", fontSize:"18px", marginTop:"100px"}}><b>Gold Karat:</b></label>
                <select
                  name="goldKt"
              ...
              <div className="col-md-3">
                <label style={{fontFamily:"'Mulish', sans-serif", fontSize:"18px", marginTop:"100px"}}><b>Diamond Type:</b></label>
                <select
                  name="diamondType"
            ...
            <div className="row">
              {Object.keys(editedProduct).map((key) => (
                ...
                <div className="col-md-3" key={key}>
                  <label style={{ textTransform: 'capitalize', marginTop:"20px", fontSize:"18px", fontFamily:"'Mulish', sans-serif"}}><b>{key}:</b></label>
                  <input
            ...
            <div className="row">
              <div className="col" style={{marginTop:"20px"}}>
                <label style={{fontSize:"20px"}}><b>Images:</b></label>
                <input
                  type="file"
                ...
                {editedProduct.productPictures && editedProduct.productPictures.map((picture, index) => (
                  <img key={index} src={`http://localhost:2000${picture.img}`} alt={`Product Image ${index}`} className="img-fluid mb-3"  style={{width:"150px", height:"150px", padding:"20px"}}/>
                ))}
  ...
  <div className="row">
    <div className="col" style={{marginTop:"20px"}}>
      <label style={{fontSize:"20px"}}><b>Video:</b></label>
      <input
        type="file"
        name="videoProduct"
        onChange={handleChange}
      ...
      />
      {editedProduct.videoProduct && (
        <video controls className="video-player" style={{height:"200px", width:"200px"}}>
    ...
    {videoFile && (
      <video controls className="video-player">
        ...
        Your browser does not support the video tag.
          ...
          <button onClick={handleSave} style={{marginTop:"30px", padding:"10px", width:"100px", borderRadius:"10px", background:"linear-gradient(to right,#DE57E5 0%,#8863FB 100%)", border:"none", color:"white"}}>Save</button>
        </div>
      )}
