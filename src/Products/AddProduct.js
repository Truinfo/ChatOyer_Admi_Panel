    ...
    <div className="container">
      <div className="row ">
        ...
        <div  style={{ display:"flex" }}>
            <IoArrowBack onClick={() => navigate(-1)} style={{ marginTop:"20px",fontSize: "30px", cursor: "pointer",  }} />
          
          <h2 className="create-add-product-header" style={{marginLeft:"20px"}}>Create Product</h2>
          </div>
          <form onSubmit={handleSubmit} className="add-category-form">
            ...
            <div className="row mb-3">
              ...
              <div className="col-md-3">
              <label>Total Product Weight:</label>
                <input
                  type="text"
            ...
            <div className="row mb-3">
              ...
              <div className="col-md-3">
              <label>Diamond Settingtype:</label>
                <input
                  type="text"
