  ...
  return (
    <div className="category-container ">
        ...
        <div  style={{ display:"flex" }}>
            ...
            <h1 className="category-header-text" style={{marginLeft:"20px"}}>Add Categories</h1>
               </div>
               </div>
      <div className="row m-4 add-category">
        <div className="col-md-6">
          <form onSubmit={handleSubmit}>
            ...
            <button type="submit" className="create-button">Create Reminder</button>
          </form>
          {showPopup && (
            <div className="popup">
